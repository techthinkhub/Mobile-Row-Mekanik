...
class RepairMaintenenEdit extends GetView<RepairMaintenenController> {
  const RepairMaintenenEdit({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('${tipeSvc??''} (Edit)', style: TextStyle(
          fontWeight: FontWeight.bold,
          color: MyColors.appPrimaryColor,
          ),
        ),
