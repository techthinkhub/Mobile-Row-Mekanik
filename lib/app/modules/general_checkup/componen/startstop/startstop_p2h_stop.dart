...
class StartStopViewG2HStop extends StatefulWidget {
  const StartStopViewG2HStop({Key? key});

  @override
  State<StartStopViewG2HStop> createState() => _StartStopViewG2HStopState();
}

class _StartStopViewG2HStopState extends State<StartStopViewG2HStop> with AutomaticKeepAliveClientMixin<StartStopViewG2HStop> {
