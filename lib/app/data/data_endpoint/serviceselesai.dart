class ServiceSelesaiHome {
  bool? status;
  String? message;
  String? namaSS;
  int? countBookingMasuk;
  List<ServiceSelesaiMasuk>? serviceSelesai;
  ...
  ServiceSelesaiHome.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    namaSS = json['namaSS'];
    countBookingMasuk = json['countBookingMasuk'];
    if (json['serviceSelesai'] != null) {
      serviceSelesai = <ServiceSelesaiMasuk>[];
      json['serviceSelesai'].forEach((v) {
        serviceSelesai!.add(new ServiceSelesaiMasuk.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.serviceSelesai != null) {
      data['serviceSelesai'] =
          this.serviceSelesai!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class ServiceSelesaiMasuk {
  int? id;
  String? kodeBooking;
  int? idJenissvc;
  int? idTipe;
  ...
  ServiceSelesaiMasuk.fromJson(Map<String, dynamic> json) {
    id = json['id'];
